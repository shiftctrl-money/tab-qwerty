...
export const VAULT_MANAGER_CONFIG = {
  abi: VaultManagerAbi,
  address: "0x3C827cA107951A9bEefb1F6B948d84D5e2838B6d",
};
export const PROTOCOL_VAULT_CONFIG = {
  abi: ProtocolVaultAbi,
  address: "0x30c61008d928C179cA51039708f413ce5e92B401",
};
export const TAB_REGISTRY_CONFIG = {
  abi: TabRegistryAbi,
  address: "0x768Dd788ae518790e1A9fcE92E2d0bbf4CedC686",
};
