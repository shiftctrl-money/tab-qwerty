...
useEffect(()=>{
  if(error){
    Swal.fire(error.shortMessage.split(":")[1]|| error.message || "Transaction reverted unexpectedly")
  }
},[error])
...
useEffect(()=>{
  if(isConfirmed){setOpen(true); Swal.close();  window.location.reload()}
},[isConfirmed])
  return (
    <>
      <div className="container mx-auto min-h-[80vh] my-10">
        ...
        <div className="grid grid-cols-7 gap-16">
          <div className="col-span-2">
            <h1 className="mt-6 text-4xl font-bold">Mint tab currencies</h1>
            <p className="mt-3 mb-10 text-sm">
              Use the simulation on the right to determine the ideal mint
              amount for you.
            </p>
            <div>
              ...
              <p className="text-sm my-4">Available For Mint:   {balance} {tokenName} </p>
              <button
                onClick={handleMint}
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none p-12">
                <div className="relative p-6 flex-auto mt-12">
                  <p className="my-4 text-blueGray-500 text-2xl text-center font-bold">
                    Tabs have been mint successfully
                  </p>
