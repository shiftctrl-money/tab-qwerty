import { ORACLE_CONFIG, stringToBytes3 } from "@/app/helpers";
        ...
        <div className="max-w-sm">
          <div className="bg-[#708395] p-5 rounded-3xl">
            ...
            <div className="flex mt-2">
              <p className="text-2xl text-white">{VaultReserveRatio()}% </p>
          ...
          <div className="bg-[#FB5108] p-5 rounded-3xl">
            ...
            <div className="mt-2">
              <p className="text-2xl text-white">
                {Number(calcLiqPrice()).toFixed(4)} {tokenName}
              </p>
            </div>
        ...
        <div className="max-w-sm">
          <div className="bg-[#695D5A] p-5 rounded-3xl">
            ...
            <div className="mt-2">
              <p className="text-2xl text-white">
                {" "}
                {vaultDetailsFn && Number(vaultDetailsFn.osTab) / 10 ** 18}{" "}
                {tokenName}
              </p>
            </div>
            <p className="text-white mt-2 text-sm">
              Currently:{" "}
              {(Number(vaultDetailsFn?.osTab) + Number(data?.tabAmt)) /
                10 ** 18}
            </p>
          </div>
